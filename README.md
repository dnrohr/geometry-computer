...
See [Getting Started](docs/GETTING_STARTED.md), [UI Specification](docs/UI_SPECIFICATION.md), [Mathematical Background](docs/MATH_BACKGROUND.md), [Origami Math Background](docs/ORIGAMI_MATH_BACKGROUND.md), [Origami Domain Model](docs/ORIGAMI_DOMAIN_MODEL.md), [Origami Rendering](docs/ORIGAMI_RENDERING.md), [Architecture](docs/ARCHITECTURE.md), and [Export Format](docs/EXPORT_FORMAT.md).
